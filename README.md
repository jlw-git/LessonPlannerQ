...
- Full lesson plans run through a draft, critic review, and one-pass revision loop before display; the UI shows returned `agentReview` notes for educator review.
