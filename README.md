...
- Reviews and revises lesson options, lesson briefs, and full lesson plans with bounded pedagogy critic and tradition reviewer loops.
...
- Lesson options, lesson briefs, and full lesson plans run through draft, critic review, and one-pass revision loops before display; the UI shows returned `optionReview` and `agentReview` notes for educator review.
